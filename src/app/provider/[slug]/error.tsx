  ...
  return (
    <main className="flex-1 flex items-center justify-center py-20 px-4" id="main-content">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-semibold text-zinc-900 mb-2">服务者信息加载失败</h2>
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link href="/" className="px-4 py-2 border border-zinc-300 rounded-lg text-sm hover:bg-zinc-50">
            返回首页
          </Link>
        </div>
      </div>
